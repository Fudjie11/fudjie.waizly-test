...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/main/v1/auth/customer-portal/account-activation/token-checker": {
            "post": {
                "description": "Customer Portal Account Activation token checker for check token code is availabe or not.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/main/v1/auth/customer-portal/login": {
            "post": {
                "description": "Authenticates customer portal users and provides an access token upon successful authentication.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/main/v1/auth/employee/account-activation/token-checker": {
            "post": {
                "description": "Employee Account Activation token checker for check token code is availabe or not.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/main/v1/auth/employee/login": {
            "post": {
                "description": "Authenticates users and provides an access token upon successful authentication.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/main/v1/auth/reset-password/token-checker": {
            "post": {
                "description": "Reset password token checker for check token code is availabe or not.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
